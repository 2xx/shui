...
<html>
	...
	<body>
		...
		<div class="panel panel-default" style="margin-top:50px;">
		  <div class="panel-heading"><h3><b>用户注册</b></h3></div>
		  <div class="panel-body">
				<form class="form-horizontal" action="./user.php?act=doreg" method="post" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-md-2">
		      <input type="text" class="form-control" id="usrtel" name="tel" placeholder="">
		    </div>
		  </div>
		  <div class="form-group">
