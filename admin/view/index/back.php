...
<div id="left-top">
    ...
    <div style="float: left" id="my_menu" class="sdmenu">
      <div class="collapsed">
        <span>用户管理</span>
        <a href="main.html" target="mainFrame" onFocus="this.blur()">浏览用户</a>
        <a href="main_list.html" target="mainFrame" onFocus="this.blur()">添加用户</a>
      </div>
      <div>
        <span>分类管理</span>
        <a href="main.html" target="mainFrame" onFocus="this.blur()">浏览分类</a>
        <a href="main_list.html" target="mainFrame" onFocus="this.blur()">添加分类</a>
      </div>
      <div>
        <span>商品管理</span>
        <a href="main.html" target="mainFrame" onFocus="this.blur()">浏览商品</a>
        <a href="main_list.html" target="mainFrame" onFocus="this.blur()">添加商品</a>
      </div>
      <div>
        <span>订单管理</span>
        <a href="main.html" target="mainFrame" onFocus="this.blur()">浏览订单</a>
      </div>
    </div>
